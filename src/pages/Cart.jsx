function CartPage() {
  return (
    <div className="justify-self-center mt-28 md:p-4 pt-0 w-full md:w-6/8">
      ...
      <div className="grid relative grid-cols-1 md:grid-cols-10 md:gap-4 w-full">
        ...
        <div className="flex flex-col justify-between sticky top-4 bg-neutral-700 col-span-3 mt-4 p-4 h-fit md:h-70 md:rounded-lg sm:mt-0">
          ...
          <div className="flex flex-col">
            ...
            <button className="bg-neutral-600 self-center justify-self-center p-3 rounded-lg">
              Confirmar compra
            </button>
          </div>
        </div>
      </div>
      <div className="bg-neutral-800 rounded-lg mt-4 h-80">
        PUEDEN INTERESAR
      </div>
    </div>
  );
