  ...
  return (
    <div className="p-5 mt-10">
      <h1 className="text-2xl md:text-4xl mb-8">
        Productos similares a los visitados
      </h1>
      <div className="grid grid-flow-col auto-cols-[calc(50%-0.5rem)] md:auto-cols-[calc(33%-0.5rem)] lg:auto-cols-[calc(16.3%-0.5rem)] gap-4 overflow-x-auto">
